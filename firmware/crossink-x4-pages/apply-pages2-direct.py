...
if old not in s:
    raise SystemExit("Pages2 stats target not found in BookStatsView.cpp")
...
if anchor not in s:
    raise SystemExit("Pages2 home helper anchor not found")
...
print("Applied direct Pages2 source edits: always-visible current-book Pages stat + Home page badge")
